       ...
       <div class="col-md-8">
        ...
        <c:if test="${product.id == 0}">
        	<div class="text-right">
	        	<br/>
	        	<button type="button" data-toggle="modal" data-target="#myCategoryModal" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-plus"></span>Add Category</button>
        	</div>
        </c:if>
 			...
 			<div class="modal-body">
 				...
 				<sf:form id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category"
 					...
 					<div class="form-group"> 						
  					...
  					<div class="form-group"> 						 						
 						<div class="col-md-offset-4 col-md-8"> 		
 							<input type="submit" value="Add Category" class="btn btn-primary"/>	<span class="glyphicon glyphicon-ok"></span>  						
 						</div> 						 					
 					</div>				
